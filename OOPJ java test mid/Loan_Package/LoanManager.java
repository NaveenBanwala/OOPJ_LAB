...
public class LoanManager{
    private static Customer[] customers={
        new Customer(1, "NAVEEN BANWALA", 50, 50000),
        new Customer(2, "SACHIN BANWALA", 26, 70000),
        new Customer(3, "SWEETY BANWALA", 28, 45000),
        new Customer(4, "MEHAK BANWALA", 25, 80000),
        new Customer(5, "ROHIT BANWALA", 25, 60000)
    };
